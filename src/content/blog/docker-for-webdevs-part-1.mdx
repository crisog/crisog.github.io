...
graph BT
    ...
    style c1 fill:#1e3a5f,stroke:#3b82f6,color:#E8E8E8
    style c2 fill:#1e3a5f,stroke:#3b82f6,color:#E8E8E8
    style c3 fill:#1e3a5f,stroke:#3b82f6,color:#E8E8E8
    style os fill:#243b53,stroke:#3b82f6,color:#E8E8E8
    style app1 fill:#152238,stroke:#3b82f6,color:#E8E8E8
    style app2 fill:#152238,stroke:#3b82f6,color:#E8E8E8
    style app3 fill:#152238,stroke:#3b82f6,color:#E8E8E8
    style k fill:#152238,stroke:#3b82f6,color:#E8E8E8
`}
</MermaidDiagram>
...
graph TB
    ...
    style image fill:#1e3a5f,stroke:#3b82f6,color:#E8E8E8
    style dockerfile fill:#3d2e0a,stroke:#d97706,color:#E8E8E8
    style code fill:#152238,stroke:#3b82f6,color:#E8E8E8
    style runtime fill:#152238,stroke:#3b82f6,color:#E8E8E8
    style libs fill:#152238,stroke:#3b82f6,color:#E8E8E8
    style deps fill:#152238,stroke:#3b82f6,color:#E8E8E8
`}
</MermaidDiagram>
