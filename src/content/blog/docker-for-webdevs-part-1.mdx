...
<MermaidDiagram
  ...
  size="lg">
{`
%%{init: {'theme':'base', 'themeVariables': { 'fontSize': '24px', 'fontFamily': 'arial', 'nodeSpacing': 100, 'rankSpacing': 100 }}}%%
graph BT
    subgraph containers[" "]
        direction LR
    ...
    subgraph os[Operating System Host]
        k[Kernel]
    end
    c1 -.-> k
    c2 -.-> k
...
graph TB
    ...
    os --> runtime --> deps --> app
    style image fill:#f3f4f6,stroke:#d1d5db
