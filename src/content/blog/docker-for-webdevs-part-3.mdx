...
graph TB
    ...
    build --> runtime
    style build fill:#3d2e0a,stroke:#d97706,color:#E8E8E8
    style runtime fill:#1e3a5f,stroke:#3b82f6,color:#E8E8E8
    style node fill:#2a2005,stroke:#d97706,color:#E8E8E8
    style deps fill:#2a2005,stroke:#d97706,color:#E8E8E8
    style src fill:#2a2005,stroke:#d97706,color:#E8E8E8
    style dist fill:#2a2005,stroke:#d97706,color:#E8E8E8
    style alpine fill:#152238,stroke:#3b82f6,color:#E8E8E8
    style app fill:#152238,stroke:#3b82f6,color:#E8E8E8
`}
</MermaidDiagram>